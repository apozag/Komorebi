...
#define IMPLEMENT_REFLECTION_PRIMITIVE(type, tag)	\
	struct CAT(TypeDescriptor_, tag) : reflect::TypeDescriptor {  \
        CAT(TypeDescriptor_, tag)() : reflect::TypeDescriptor{ #type, sizeof(type) } {}   \
    ...
    template <> \
	reflect::TypeDescriptor* reflect::getPrimitiveDescriptor<type>() {    \
        static  CAT(TypeDescriptor_, tag) typeDesc;   \
        return &typeDesc;   \
    }
...
DECLARE_REFLECTION_PRIMITIVE(char*)
